...
const WorkerView = () => {
  ...
  const [rating_submit, setRatingSubmit] = useState(true)
   ...
   const userratingRef=ref(database, 'usersRating/' + userId + '/rating');
   const rating_submitRef=ref(database, 'usersRating' + userId + 'rating_submit');
 ...
 useEffect(() => {
  ...
  const handleSettingsClick = () => {
    ...
    navigate(`/seeker_settings/${actualID}`);
  };

  const handleHomeClick = () => {
    // Implement home functionality here
    navigate(`/SeekerHomePage/${actualID}`);
  };

  const handleSearchClick = () => {
    // Implement search functionality here
    navigate(`/search_bar_seeker/${actualID}`);
  };


  const handleReviewClick = () => {
    // Implement search functionality here
    navigate(`/reviews_seeker/${actualID}`);
  };
    ...
    <div className="container1">
      ...
      <div className='circular-rectangle-wrapper5'>
           <div className='circular-rectangle19' style={{ overflowX: 'hidden', overflowY: 'auto' }}>
            ...
            <div style={{ position: 'absolute', top: '152px',  left: '25px', fontSize: '25px', zIndex: '1', justifyContent: 'center', alignItems: 'center'}}>
            ...
            <div style={{ position: 'absolute', top: '230px',  left: '25px', fontSize: '25px', zIndex: '1', justifyContent: 'center', alignItems: 'center'}}>
                       Phone:
            </div>
            <div style={{ position: 'absolute', top: '259px',  left: '25px', fontSize: '25px', zIndex: '1', justifyContent: 'center', alignItems: 'center'}}>
            ...
            <div style={{ position: 'absolute', top: '331px',  left: '25px', fontSize: '25px', zIndex: '1', justifyContent: 'center', alignItems: 'center'}}>
                       Description:
            </div>
            <div style={{ position: 'absolute', top: '365px',  left: '25px', fontSize: '25px', zIndex: '1', justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    <label>
                       ...
                       <textarea
                           ...
                           className='customizeLoginInput10000'
                        />
                       </div>
            ...
            <div className='circular-rectangle20' style={{ overflowX: 'hidden', overflowY: 'auto' }}>
              ...
              <div style={{ position: 'absolute', top: '200px', left: '20px', fontSize: '25px', zIndex: '1', justifyContent: 'center', alignItems: 'center' }}>
                <Rating
              ...
              <div style={{ position: 'absolute', top: '380px',  left: '25px', fontSize: '25px', zIndex: '1', justifyContent: 'center', alignItems: 'center'}}>
                      Please rate House Helpers as accurately as possible!
              </div>
