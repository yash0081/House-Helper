      ...
      <div className='rightSeekerHome'>
        ...
        <div>
          {userRating === 0 && (
            <>
              <div className="sub_welcome">
                Build your profile by hiring House Helpers with our custom Search and Messaging features.
                Make sure to also ASK for ratings so you too can earn the coveted 5 Stars below:
              </div>
          ...
          {userRating > 0 && (
            <>
              <div className="sub_welcome">
                You are viewed by your House Helpers as:
              </div>
              ...
              {userRating >= 0 && <div className="sub_welcome2">Reach out to your Helpers for improval tips!</div>}
